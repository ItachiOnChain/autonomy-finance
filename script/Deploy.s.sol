...
contract DeployScript is Script {
    function run() external {
        ...
        MockComet mockComet = new MockComet(address(collateral), "Compound mETH", "cmETH", 0.04e18);
        ...
        CometAdapter adapter = new CometAdapter(deployer, IERC20Minimal(address(collateral)), address(mockComet));

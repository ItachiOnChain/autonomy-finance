...
contract DeployScript is Script {
    ...
    function run() external {
        ...
        assets[0] = address(usdc); prices[0] = 1e18;
        assets[1] = address(usdt); prices[1] = 1e18;
        assets[2] = address(weth); prices[2] = 3000e18;
        assets[3] = address(wbtc); prices[3] = 60000e18;
        assets[4] = address(dai);  prices[4] = 1e18;
        assets[5] = address(link); prices[5] = 15e18;
        assets[6] = address(uni);  prices[6] = 10e18;
        assets[7] = address(aave); prices[7] = 100e18;
        ...
        console.log("Multi-asset support configured - AutoRepayEngine can now scan ALL assets!");
